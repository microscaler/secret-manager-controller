...
impl ParameterManagerREST {
    ...
    /// Format parameter path for API calls
    ///
    /// Format: `projects/{project}/locations/{location}/parameters/{parameter_id}`
    fn format_parameter_path(&self, parameter_id: &str) -> String {
        format!(
            "projects/{}/locations/{}/parameters/{}",
            self.project_id, self.location, parameter_id
        )
    }

    /// Format parameter parent path for API calls
    ///
    /// Format: `projects/{project}/locations/{location}/parameters`
    fn format_parameter_parent_path(&self) -> String {
        format!(
            "projects/{}/locations/{}/parameters",
    ...
    /// Format parameter version path for API calls
    ///
    /// Format: `projects/{project}/locations/{location}/parameters/{parameter_id}/versions/{version_id}`
    fn format_parameter_version_path(&self, parameter_id: &str, version_id: &str) -> String {
        format!(
            "projects/{}/locations/{}/parameters/{}/versions/{}",
            self.project_id, self.location, parameter_id, version_id
        )
    }

    /// Format parameter versions parent path for API calls
    ///
    /// Format: `projects/{project}/locations/{location}/parameters/{parameter_id}/versions`
    fn format_parameter_versions_parent_path(&self, parameter_id: &str) -> String {
        format!(
            "projects/{}/locations/{}/parameters/{}/versions",
            self.project_id, self.location, parameter_id
        )
    ...
    pub async fn get_parameter(&self, parameter_name: &str) -> Result<Option<Parameter>> {
        ...
        async move {
            ...
            let parameter_path = self_ref.format_parameter_path(parameter_name);
    ...
    pub async fn list_parameters(&self) -> Result<ListParametersResponse> {
        ...
        async move {
            ...
            let parameters_path = self_ref.format_parameter_parent_path();
            let response = self_ref
    ...
    pub async fn get_version(
        ...
        async move {
            ...
            let version_path = self_ref.format_parameter_version_path(parameter_name, version_id);
            let response = self_ref
    ...
    pub async fn list_versions(
        ...
        async move {
            ...
            let versions_path = self_ref.format_parameter_versions_parent_path(parameter_name);
            let response = self_ref
    ...
    pub async fn render_version(
        ...
        async move {
            ...
            // Render endpoint uses :render suffix
    ...
    pub async fn get_location(&self, location_name: &str) -> Result<Option<Location>> {
        ...
        async move {
            ...
            let location_path = format!("projects/{}/locations/{}", project_id, location_name);
            let response = self_ref
    ...
    pub async fn list_locations(&self) -> Result<ListLocationsResponse> {
        ...
        async move {
            ...
            let locations_path = format!("projects/{}/locations", project_id);
            let response = self_ref
...
impl ConfigStoreProvider for ParameterManagerREST {
        ...
        async move {
            ...
            if existing_parameter.is_none() {
                ...
                let response = self_ref
                    .make_request(
                        "POST",
                        &self_ref.format_parameter_parent_path(),
            ...
            let response = self_ref
                .make_request(
                    "POST",
                    &self_ref.format_parameter_versions_parent_path(config_key),
    ...
    async fn get_config_value(&self, config_key: &str) -> Result<Option<String>> {
        ...
        async move {
            ...
            let versions_path = self_ref.format_parameter_versions_parent_path(config_key);
            let response = self_ref
                .make_request("GET", &versions_path, None)
                .send()
                .await
            ...
            let version_path = self_ref.format_parameter_version_path(config_key, version_id);
            let response = self_ref
                .make_request("GET", &version_path, None)
                .send()
                .await
    ...
    async fn delete_config(&self, config_key: &str) -> Result<()> {
        ...
        async move {
            ...
            let path = self_ref.format_parameter_path(config_key);
