...
async fn test_azure_app_config_put_key_value_contract() {
    ...
    pact_builder.interaction("create or update a key-value pair in Azure App Configuration", "", |mut i| {
...
async fn test_azure_app_config_get_key_value_contract() {
    ...
    pact_builder.interaction("get a key-value pair from Azure App Configuration", "", |mut i| {
...
async fn test_azure_app_config_get_key_value_not_found_contract() {
    ...
    pact_builder.interaction("get a non-existent key-value pair from Azure App Configuration", "", |mut i| {
...
async fn test_azure_app_config_delete_key_value_contract() {
    ...
    pact_builder.interaction("delete a key-value pair from Azure App Configuration", "", |mut i| {
        i.given("a key-value pair exists in Azure App Configuration");
        i.request
            .method("DELETE")
            .path("/kv/my-service:prod:database.host")
...
async fn test_azure_app_config_delete_key_value_not_found_contract() {
    ...
    pact_builder.interaction("delete a non-existent key-value pair from Azure App Configuration", "", |mut i| {
        i.given("the key-value pair does not exist");
        i.request
            .method("DELETE")
            .path("/kv/my-service:prod:nonexistent.key")
...
async fn test_azure_app_config_update_existing_key_value_contract() {
    ...
    pact_builder.interaction("update an existing key-value pair in Azure App Configuration", "", |mut i| {
        i.given("a key-value pair exists in Azure App Configuration");
        i.request
            .method("PUT")
            .path("/kv")
