//! GCP End-to-End Reconciliation Tests
//!
//! Tests the full controller reconciliation flow with GCP Secret Manager mock server.
//!
//! These tests verify:
...
mod tests {
    ...
    async fn test_gcp_full_reconciliation_create_secrets_flux() {
        init_test();
        ...
        let git_repo_name = "test-gcp-repo-flux";
        let profile = "tilt";
    ...
    #[tokio::test]
    #[ignore] // Requires Kind cluster and mock server
    async fn test_gcp_full_reconciliation_update_secrets_flux() {
        init_test();
        ...
        let namespace = "default";
        let git_repo_name = "test-gcp-repo-update-flux";
        let profile = "tilt";
        ...
        // Create GitRepository and SecretManagerConfig (similar to create test)
        let _git_repo = create_flux_git_repository(
            &client,
            git_repo_name,
            namespace,
    ...
    #[tokio::test]
    #[ignore] // Requires Kind cluster and mock server
    async fn test_gcp_full_reconciliation_delete_secrets_flux() {
        init_test();
        ...
        let namespace = "default";
        let git_repo_name = "test-gcp-repo-delete-flux";
        let profile = "tilt";
        ...
        // Verify API_KEY still exists, DATABASE_PASSWORD should be deleted
        // Note: Actual deletion verification depends on controller implementation
        // For now, we verify API_KEY still exists
        let verified = verify_gcp_secret(
            &endpoint,
            "test-project",
            "test-service-API_KEY",
    ...
    #[tokio::test]
    #[ignore] // Requires Kind cluster and mock server
    async fn test_gcp_full_reconciliation_disable_secrets_flux() {
        init_test();
        ...
        let namespace = "default";
        let git_repo_name = "test-gcp-repo-disable-flux";
        let profile = "tilt";
        ...
        // Verify secret is disabled (implementation depends on controller)
        // For now, we just verify reconciliation succeeded
    ...
    #[tokio::test]
    #[ignore] // Requires Kind cluster and mock server
    async fn test_gcp_full_reconciliation_create_secrets_argocd() {
        init_test();
        ...
        let app_name = "test-gcp-app-argocd";
        let profile = "tilt";
        ...
        let config = create_test_secret_manager_config_argocd(
            "test-gcp-reconciliation-argocd",
            "default",
            "test-project",
            &endpoint,
            app_name,
    ...
    // Additional ArgoCD tests (update, delete, disable) would follow similar pattern
    // but using ArgoCD Application instead of GitRepository
}
