//! Azure End-to-End Reconciliation Tests
//!
//! Tests the full controller reconciliation flow with Azure Key Vault mock server.
//!
//! These tests verify:
...
mod tests {
    ...
    async fn test_azure_full_reconciliation_create_secrets_flux() {
        init_test();
        ...
        let git_repo_name = "test-azure-repo-flux";
        let profile = "tilt";
        ...
        let config = create_test_secret_manager_config_azure_flux(
            "test-azure-reconciliation-flux",
            namespace,
            "test-vault",
            &endpoint,
            git_repo_name,
        ...
        let verified1 = verify_azure_secret(
            &endpoint,
        ...
        let verified2 =
            verify_azure_secret(&endpoint, "test-service-API_KEY", Some("test-api-key-456"))
                .await
                .expect("Failed to verify secret");
    ...
    #[tokio::test]
    #[ignore] // Requires Kind cluster and mock server
    async fn test_azure_full_reconciliation_update_secrets_flux() {
        init_test();
        ...
        let namespace = "default";
        let git_repo_name = "test-azure-repo-update-flux";
        let profile = "tilt";
        ...
        let verified = verify_azure_secret(
            &endpoint,
            "test-service-DATABASE_PASSWORD",
    ...
    #[tokio::test]
    #[ignore] // Requires Kind cluster and mock server
    async fn test_azure_full_reconciliation_delete_secrets_flux() {
        init_test();
        ...
        let namespace = "default";
        let git_repo_name = "test-azure-repo-delete-flux";
        let profile = "tilt";
        ...
        let verified = verify_azure_secret(&endpoint, "test-service-API_KEY", Some("test-key"))
            .await
            .expect("Failed to verify secret");
    ...
    #[tokio::test]
    #[ignore] // Requires Kind cluster and mock server
    async fn test_azure_full_reconciliation_disable_secrets_flux() {
        init_test();
        ...
        let namespace = "default";
        let git_repo_name = "test-azure-repo-disable-flux";
        let profile = "tilt";
    ...
    #[tokio::test]
    #[ignore] // Requires Kind cluster and mock server
    async fn test_azure_full_reconciliation_create_secrets_argocd() {
        init_test();
        ...
        let app_name = "test-azure-app-argocd";
        let profile = "tilt";
        ...
        let config = create_test_secret_manager_config_azure_argocd(
            "test-azure-reconciliation-argocd",
            "default",
            "test-vault",
            &endpoint,
            app_name,
