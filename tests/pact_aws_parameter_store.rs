...
async fn test_aws_put_parameter_create_contract() {
    ...
    pact_builder
        .interaction("create a new parameter in AWS Parameter Store", "", |mut i| {
...
async fn test_aws_put_parameter_update_contract() {
    ...
    pact_builder
        .interaction("update an existing parameter in AWS Parameter Store", "", |mut i| {
...
async fn test_aws_get_parameter_not_found_contract() {
    ...
    pact_builder
        .interaction("get a parameter that does not exist", "", |mut i| {
...
async fn test_aws_delete_parameter_contract() {
    ...
    pact_builder
        .interaction("delete a parameter from AWS Parameter Store", "", |mut i| {
            i.given("a parameter exists");
            i.request
                .method("POST")
                .path("/")
...
async fn test_aws_get_parameters_by_path_contract() {
    ...
    pact_builder
        .interaction("list parameters by path", "", |mut i| {
